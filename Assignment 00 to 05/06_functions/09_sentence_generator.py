...
def  make_sentence(word,part_of_speech):
    if part_of_speech == 0:
        ...
        print(f"\033[94mIt's so nice outside today it makes me want to {word}!\033[0m]")
    elif part_of_speech == 2:
        print(f"\033[94mLooking out my window, the sky is big and {word}!\033[94m")
    else:
        print("Sorry we can not make sentence .Number must be 0 , 1 or 2. ")

def main():
    word=input("please type a noun , verb or adjective: ")
    print("Is this is a noun , verb or adjective?")
